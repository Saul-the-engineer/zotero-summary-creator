/**
 * Centralized error messages and error types for Zotero Summary Creator
 */
 ...
 * @returns {Error}
 */
export function createError(errorType, additionalInfo = '') {
 ...
 * @returns {Error}
 */
export function createOllamaError(originalMessage) {
