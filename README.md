...
1. Go to **Tools → Summary Creator Preferences**
...
**In Preferences UI:**
1. Go to **Tools → Summary Creator Preferences**
2. Change **Model Name** field (e.g., `llama2`, `mistral`, `codellama`)
3. Make sure the model is downloaded: `ollama pull mistral`

**Recommended Models:**
- `llama2` (7B) - Good balance of speed/quality, ~4GB VRAM
...
3. **Ollama crashed** - Check `ollama serve` output
4. **Out of VRAM** - Use smaller model: `ollama pull llama2:7b-q4_0`
...
2. ✅ Check plugin installed: **Tools → Add-ons**
3. ✅ Review preferences: **Tools → Summary Creator Preferences**
4. ✅ Check debug output: **Help → Debug Output Logging → View Output**
...
- Update model: `ollama pull llama2`
